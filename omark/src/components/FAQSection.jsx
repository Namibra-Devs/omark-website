...
const FAQSection = () => {
  ...
  const faqs = [
    {
      id: 1,
      question: 'What areas does Omark Real Estate serve?',
      answer: 'Omark Real Estate & Construction is based in Kumasi, with strategically located offices in Pankrono and Atimatim. We serve the entire Ashanti Region and surrounding areas, with plans to expand to other regions in Ghana.'
    },
    {
      id: 2,
      question: 'How do I start the home buying process?',
      answer: 'The home buying process at Omark is simple: 1) Schedule a consultation with our team, 2) Browse available properties, 3) Choose your preferred payment plan, 4) Complete documentation, 5) Move into your new home.'
    },
    {
      id: 3,
      question: 'What payment options are available?',
      answer: 'We offer flexible payment plans including: outright purchase, installment payments, mortgage financing partnerships, and government-backed affordable housing schemes.'
    },
    {
      id: 4,
      question: 'Do you offer custom home construction?',
      answer: 'Absolutely! We offer custom home construction services where you can design your dream home with our architects. We handle everything from design to completion.'
    },
    {
      id: 5,
      question: 'Is the property title guaranteed?',
      answer: 'Yes, all Omark properties come with verified and registered land titles. We ensure all legal documentation is properly processed through the Lands Commission.'
    },
    {
      id: 6,
      question: 'Can foreigners buy property from Omark?',
      answer: 'Yes, foreigners can purchase property in Ghana. We work with international clients and can assist with the legal requirements for foreign ownership.'
    }
  ];
          ...
          <div className="relative">
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.target.src = 'https://placehold.co/600x800/2c3e50/f59e0b?text=Modern+Luxury+Home';
                }}
              />
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-amber-500 rounded-full opacity-20 blur-2xl -z-10"></div>
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-amber-600 rounded-full opacity-20 blur-2xl -z-10"></div>
          </div>
        </div>
        ...
        <div className="mt-16 p-6 bg-gradient-to-r from-red-50 to-red-100/50 rounded-2xl text-center">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <Link
                to="/contact"
                className="bg-red-700 hover:bg-red-800 text-white px-6 py-2 rounded-md font-semibold transition"
              >
                Contact Us
              </Link>
              <a
